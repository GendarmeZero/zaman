...
const Main = () => {
  ...
  return (
    ...
    >
      ...
      <div className="my-[0.4375rem] flex flex-1 flex-col justify-center gap-[3.0625rem] text-center text-normal md:my-[1.5625rem] md:mx-[2.1875rem] md:text-left lg:my-[6.4375rem]" style={{ marginTop: '0px' }}>
        ...
        <p className="max-w-[43ch] leading-[1.6] tracking-[0.01em] text-medium-gray transition duration-300 ease-in-out dark:text-almost-white md:text-normal max-md:mx-auto">
          Enhance your daily routine with the natural energy boost of Zaman Honey. Wherever you are, let our premium honey elevate your productivity and well-being
        </p>
        <a
          href="#"
